...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2026 at 01:36 PM
...
(1, 'Atomic Habits', '2018', 1, 4, 2147483647);
...
--
ALTER TABLE `bookcopy`
  MODIFY `BookCopy_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `borrowdetails`
  MODIFY `BorrowDetails_ID` int(11) NOT NULL AUTO_INCREMENT;
